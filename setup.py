...
setup(
  name = 'pyshell',         # How you named your package folder (MyLib)
  packages = ['pyshell'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/kapten-kaizo/pyshell/archive/refs/tags/V1.tar.gz',    # I explain this later on
